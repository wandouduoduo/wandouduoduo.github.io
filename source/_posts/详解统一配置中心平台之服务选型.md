...
![](详解携程Apollo统一配置中心平台-一/5.png)

**各组件作用说明**

![](详解携程Apollo统一配置中心平台-一/6.png)

**Apollo HA高可用设计**

![](详解携程Apollo统一配置中心平台-一/7.png)

#### Apollo客户端架构

![](详解携程Apollo统一配置中心平台-一/8.png)
