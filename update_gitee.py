# -*- coding: utf-8 -*-
# @Time    : 2020/7/10 23:16
# @Author  : Sun
# @FileName: update_gitee.py
# -*- coding: utf-8 -*-
import time
...
user_login.send_keys("xxxxxxxxxxxx@163.com")
# 输入密码--通过html的id属性定位输入位置--改为你的密码
driver.find_element_by_id('user_password').send_keys("xxxxxxxxxxxxxxxx")
...
driver.get('https://gitee.com/wandouduoduo/wandouduoduo/pages')
# 点击更新按钮--通过xpath确定点击位置
element = driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/div[2]/div/form/div[7]')
